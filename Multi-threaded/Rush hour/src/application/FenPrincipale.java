...
public class FenPrincipale extends Application {
    ...
    /**
     * bouton qui permet de passer à la prochaine grille
     */
    private Button btnProchain;
    /**
     * bouton qui résous la grille
     */
    private Button btnResoudre;
    /**
     * index courante de la grille dans l'enum FichierGrilles
     */
    private int intNoGrille = 0;
    /**
     * valeur du Slider de vitesse
     */
